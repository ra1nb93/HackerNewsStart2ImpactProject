...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function getNews(ids) {
    var promises = ids.slice(startIndex, startIndex + batchSize).map(function (id) {
  ...
  function getPhotoFromTitle(title) {
    var apiKey = 'PjkpjWJTw8yIKV65mcBUFN7BC4J60u6r325YXWGCHeCIlEDpxFBS8EHo';
    var searchUrl = "https://api.pexels.com/v1/search?query=".concat(encodeURIComponent(title), "&per_page=1");
  ...
  function getNewsOnScreen(newsArray) {
    ...
    newsArray.forEach( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(item) {
        var newsItem, imageUrl;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return getPhotoFromTitle(item.title);
            case 4:
  ...
  callFetch('https://hacker-news.firebaseio.com/v0/newstories.json').then(function (newsIds) {
    ...
    return console.error('Error fetching news IDs:', error);
  });
});
/******/ })()
;
